  ...
  public: {
    Tables: {
      ...
      commissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "commissions_dsr_id_fkey"
            columns: ["dsr_id"]
            isOneToOne: false
      ...
      managers: {
        ...
        Relationships: [
          {
            foreignKeyName: "managers_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      tl_targets: {
        ...
        Relationships: [
          {
            foreignKeyName: "tl_targets_tl_id_fkey"
            columns: ["tl_id"]
            isOneToOne: false
            referencedRelation: "team_leaders"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "manager" | "tl" | "dsr" | "de"
